import unittest
from Simulacro.simulacro import ultima_aparicion
from Simulacro.simulacro import elementos_exclusivos
from Simulacro.simulacro import contar_traducciones_iguales
from Simulacro.simulacro import convertir_a_diccionario
